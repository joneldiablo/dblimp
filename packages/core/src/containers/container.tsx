...
> extends Component<TProps, TState> {
  ...
  protected width = 0;
  protected height = 0;
  protected waitBreakpoint = (
  <svg className="spinner" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <style>{`.spinner-anim { transform-origin: center; animation: spin 1s linear infinite; } @keyframes spin { 100% { transform: rotate(360deg); } }`}</style>
    <path className="spinner-anim" d="M12 4a8 8 0 018 8h-2a6 6 0 00-6-6V4z" fill="currentColor"/>
  </svg>
);
